                            ...
                            <td class="text-center align-middle">
                                <?php if ($this->session->userdata('role') == 'admin') : ?>
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?= base_url('penduduk/hapus/') . $p['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data penduduk ini?');" title="Hapus Data" data-toggle="tooltip">
